...
const FEATURES = [
  'Visit Authorization Request (VAR) intake and approval workflow',
  'Clearance verification against DISS/NISS before facility entry',
  'Escort assignment and responsibility log',
  'Visitor badge issuance with timed expiry',
  'Uncleared visitor escort tracking — sign-in/out with escort name',
  'Foreign national visit approval process — special access and DOHA referrals',
];
    ...
    <div className="p-6 max-w-4xl">
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-100">Visitor Management</h1>
            <p className="text-sm text-slate-400">Visit Authorization Requests, escort logs, clearance verification</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-slate-800 bg-slate-900/50 p-8 text-center mb-6">
        ...
        <p className="text-sm text-slate-500 max-w-md mx-auto">
          Visitor Management will handle the full Visit Authorization Request process, from initial request through escort tracking and post-visit records.
        </p>
      </div>
